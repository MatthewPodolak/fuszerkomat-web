...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="navbar-end gap-2">
            {isAuthed ? (
              <div className="flex items-center gap-4">
                ...
                {(claim && claim === "User") && (
                  <div onClick={() => setIsQuestOpen(true)} className="rounded-full cursor-pointer">
                ...
                <div onClick={() => navigate("/chat")} className="rounded-full cursor-pointer">
        ...
        <Questionary open={isQuestOpen} onClose={() => setIsQuestOpen(false)} />
    </>
  );
}